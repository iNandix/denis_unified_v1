...
def create_and_save_action_plan_snapshot(
    intent_v1: Intent_v1,
    candidates: list[ActionPlanCandidate],
    selected: ActionPlanCandidate,
    reports_dir: Path,
):
    plan_set = ActionPlanSet(
        ...
        selection_reason_codes=[
            "band_" + intent_v1.confidence_band + "_forces_read_only"
            if not selected.is_mutating
            else "high_confidence_allows_mutating"
        ],
    )
    ...
    plan_a = ActionPlanCandidate(
        ...
        steps=[
            ...
            ActionStep(
                ...
                read_only=True,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "pytest -q --tb=no"})
                ],
    ...
    plan_b = ActionPlanCandidate(
        ...
        steps=[
            ...
            ActionStep(
                ...
                read_only=False,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "echo 'Fixes applied'"})
                ],
    ...
    plan_a = ActionPlanCandidate(
        ...
        steps=[
            ActionStep(
                ...
                read_only=True,
                tool_calls=[
                    ToolCall(name="grep_search", args={"pattern": "ERROR|Exception"})
                ],
            ...
            ActionStep(
                ...
                read_only=True,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "git log --oneline -10"})
                ],
    ...
    plan_b = ActionPlanCandidate(
        ...
        steps=[
            ...
            ActionStep(
                ...
                tool_calls=[
                    ToolCall(
                        name="run_command", args={"cmd": "echo 'Reproduce attempt'"}
                    )
                ],
        ...
        steps=[
            ActionStep(
                ...
                tool_calls=[
                    ToolCall(
                        name="run_command",
                        args={"cmd": "curl -s http://localhost:3001/healthz"},
                    )
                ],
    ...
    plan_b = ActionPlanCandidate(
        ...
        steps=[
            ActionStep(
                ...
                read_only=True,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "systemctl status"})
                ],
                evidence_required=["service_statuses", "error_logs"],
                stop_if=[
                    StopCondition(key="critical_services_down", op=StopOp.is_true)
                ],
            )
        ],
    )
    ...
    plan_a = ActionPlanCandidate(
        ...
        steps=[
            ...
            ActionStep(
                ...
                read_only=True,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "echo 'Design sketch'"})
                ],
    ...
    plan_b = ActionPlanCandidate(
        ...
        steps=[
            ActionStep(
                ...
                read_only=False,
                tool_calls=[
                    ToolCall(name="run_command", args={"cmd": "echo 'Implement core'"})
                ],
